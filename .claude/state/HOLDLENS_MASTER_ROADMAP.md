...
| 8 | 2 | Portfolio Similarity Scorer | `/similar-to/` | **next candidate** | — | — | — | Algorithmic layer on existing 13F data. Pure code — no new data pipeline. Projected APS 38-44. Thesis: drives exploration of new investors → retention. |
