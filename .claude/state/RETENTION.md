...
2026-04-25 | v1.67 EngagementTracker scroll+time+returning  | bug_fix_blocking_core    | +0.000 Δ 7d-return | TBD | TBD | unblocks retention MEASUREMENT (4 events: scroll/time/returning/activated), not retention itself. Reach ~1.0 (every page). Real compound = next-session Oracle calibration lands actual numbers instead of placeholders
2026-04-25 | v1.68 /learn/form-4-vs-13f                 | SEO_page_addition        | +0.001 Δ 7d-return | TBD | TBD | typical SEO content has slight neg retention; cross-links to 6 high-intent surfaces + LearnReadNext "next article" loop closure flips signal slightly positive. Reach low — only users who land on this page or on /insiders/ /for-ai/ /learn/insider-score-explained /learn/sec-signals-trilogy
2026-04-25 | v1.68 cross-links from /insiders/ /for-ai/ /learn/* | internal_linking_hub_spoke | +0.005 Δ 7d-return | TBD | TBD | LearnReadNext bounce fix pattern proven on prior article ships; adding "next page" surfaces on engaged pages reduces single-session bounce. Reach ~0.3 (proportion of users hitting cross-linked surfaces)
```
...
## Calibration
2026-04-20 12:39 | v1.54-monetization-layer | delight_detail+copy_clarity | projected_d7_delta: +0.5% (paid-tier awareness via footer /for-ai link + clearer API tier structure) | actual_7d: TBD | actual_30d: TBD | confidence: 0.5 | hypothesis: humans browsing /pricing now also see commercial tier → cross-segment premium consideration

## Calibration (2026-04-30 — 11-ship SEC-data discoverability + Standard branding loop)
2026-04-30 22:15 | 11-ship-loop-2026-04-30 | core_loop_improvement+craftsmanship_polish+copy_clarity+new_feature_usefulness | projected_d7_delta: +0.4% returning_session_d7 | actual_7d: TBD | actual_30d: TBD | reach: 1.0 (homepage hero eyebrow + nav rebrand + 30 investor-page eyebrows + 6 hub schemas hit every visitor) | confidence: 0.3 (cold for "Standard branding" archetype; first calibration sample) | hypothesis: returning users notice the new Standard positioning (eyebrow pill + /methodology v2.0 roadmap page). Cohesion compounds brand recall → branded direct-typed return-visit lift. Counterfactual: if Standard-eyebrow is invisible to users (just brand-internal noise), no measurable retention lift. Calibration target: 7d retention delta vs the 30d-prior Plausible baseline. If ≥+0.4% confirms; if 0±0.2% archetype-multiplier holds at cold; if negative, audit eyebrow visual prominence per @craftsman.
